...
// 1. Add data sources 
    ...
    map.addSource('outdoor-bike-parking', { // ID created
        type: 'geojson',
        data: 'https://nadineconsunji.github.io/GGR472_Lab2/OutdoorBicycleParking.geojson' //CHANGE THIS RIGHT HERE!!!
    });

	// Bike lanes - GeoJSON file (added via URL for organisation)
    map.addSource('bike-lanes', { 
        type: 'geojson',
        data: 'https://nadineconsunji.github.io/GGR472_Lab2/BikeRoutes.geojson' //CHANGE THIS RIGHT HERE!!! 
    });
